...
REM ============================================================
cd /d "%~dp0"
echo [1/4] Installing project dependencies (flask, gradio_client, ...) ...
python -m pip install --upgrade -r requirements.txt
echo [2/4] Installing playwright python package...
python -m pip install --upgrade playwright
echo [3/4] Installing agent Chromium (this downloads ~170MB once)...
python -m playwright install chromium
echo [4/4] Installing scrapling (stealth fetching for the scout)...
